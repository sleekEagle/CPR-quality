...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default=r'C:\Users\lahir\code\CPR-quality\sam_vit_h_4b8939.pth',help="Path to the model checkpoint file")
    parser.add_argument("--data", default=r'D:\CPR_dataset\canon_images_selected2', help="Path to the data directory")
